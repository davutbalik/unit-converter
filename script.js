const Kelvin = prompt("Hava sıcaklığı kaç Kelvin'dir?") //The value saved to kelvin will stay constant.
const Celsius = Kelvin - 273 //Kelvin to Celsius by subtracting 273 from the kelvin
let Fahrenheit = Celsius * (9/5) + 32
Fahrenheit = Math.round(Fahrenheit);
console.log(`Hava sıcaklığı ${Fahrenheit} derece fahrenayttır.`);
alert(`Hava sıcaklığı ${Fahrenheit} derece fahrenayttır.`);
